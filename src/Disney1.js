...
const image23 = `${process.env.PUBLIC_URL}/Images/Barbie16.png`;
...
<div>
  <a href="URL_HERE">Travel // United States</a>
</div>
<div>    <img src= {image1} alt = 'b1' style={{width:'100%'}}></img></div>
...
Welcome to the part one of my magical recap of an unforgettable time at
...
<div> <img src= {image1A} alt = 'b1' style={{width:'100%'}}></img></div>
<div> <img src= {image2} alt = 'b1' style={{width:'100%'}}></img></div>
<div> <img src= {image3} alt = 'b1' style={{width:'100%'}}></img></div>
<div> <img src= {image4} alt = 'b1' style={{width:'100%'}}></img></div>
...
<div> <img src= {image6} alt = 'b1' style={{width:'100%'}}></img></div>


<p style={{ fontSize:'1.5rem', fontFamily: 'GFS Didot, serif', margin: '1rem', maxWidth:'100%' , marginLeft: '0em'}}>
We chose a standard room with a garden view, and although the rooms'
...
<p style={{ fontSize:'1.5rem', fontFamily: 'GFS Didot, serif', margin: '1rem', maxWidth:'100%' , marginLeft: '0em'}}>
Disney's Beach Club Resort offers a
range of room types to suit various guest
needs, from Standard Rooms that
accommodate up to five guests with two
queen beds and a day bed. Need more
room? There are more spacious Deluxe
Rooms and luxurious Club Level
Rooms with exclusive lounge access.
</p>

<div> <img src= {image7} alt = 'b1' style={{width:'100%'}}></img></div>
...
<div>
    <div> <img src= {image8} alt = 'b1' style={{width:'100%'}}></img></div>
    <div> <img src= {image9} alt = 'b1' style={{width:'100%'}}></img></div>
</div>
...
<div>
    <div> <img src= {image10} alt = 'b1' style={{width:'100%'}}></img></div>
    <div> <img src= {image11} alt = 'b1' style={{width:'100%'}}></img></div>
</div>
...
<div>
    <div> <img src= {image12} alt = 'b1' style={{width:'100%'}}></img></div>
    <div> <img src= {image13} alt = 'b1' style={{width:'100%'}}></img></div>
</div>
...
<div>
    <div> <img src= {image14} alt = 'b1' style={{width:'100%'}}></img></div>
    <div> <img src= {image15} alt = 'b1' style={{width:'100%'}}></img></div>
</div>
...
<div>
    <div> <img src= {image16} alt = 'b1' style={{width:'100%'}}></img></div>
    <div> <img src= {image17} alt = 'b1' style={{width:'100%'}}></img></div>
</div>
...
<div> <img src= {image18} alt = 'b1' style={{width:'100%'}}></img></div>
...
<div>
    <div> <img src= {image19} alt = 'b1' style={{width:'100%'}}></img></div>
    <div> <img src= {image20} alt = 'b1' style={{width:'100%'}}></img></div>
</div>
...
<p style={{ fontSize:'1.5rem', fontFamily: 'GFS Didot, serif', margin: '1rem', maxWidth:'100%' , marginLeft: '0em'}}>
If you enjoy a nautical theme, you
may be choosing between the Beach
Club, Yacht Club, and Disney’s
Polynesian Village Resort.
</p>
<p style={{ fontSize:'1.5rem', fontFamily: 'GFS Didot, serif', margin: '1rem', maxWidth:'100%' , marginLeft: '0em'}}>
I say go with Beach Club between
The Yacht and Beach Club Resort
simply because of the shared
amenities. While Yacht Club is
slightly more sophisticated, the light
blue and white stands out and feels
more enchanting!
</p>

<p style={{ fontSize:'1.5rem', fontFamily: 'GFS Didot, serif', margin: '1rem', maxWidth:'100%' , marginLeft: '0em'}}>
For those drawn to the serene allure
of the tropics, Disney's Polynesian
Village Resort transports guests to a
South Pacific paradise, complete with
monorail access to the parks and celebrated dining experiences like 'Ohana.
It is for sure on my bucket list to stay at the Polynesian resort in the future!
</p>
<p style={{ fontSize:'1.5rem', fontFamily: 'GFS Didot, serif', margin: '1rem', maxWidth:'100%' , marginLeft: '0em'}}>
...
comments, or on the blog. To read about my Disney Park experiences, see
here.
</p>


<div> <img src= {image21} alt = 'b1' style={{width:'100%'}}></img></div>




<div> <img src= {image22} alt = 'b1' style={{width:'100%'}}></img></div>
...
<Card
        ...
        <HyvorTalkComments
        websiteId={websiteId}
        pageId={"disney-1"} // Unique identifier for this blog post
    /></div></div>
    );
};
