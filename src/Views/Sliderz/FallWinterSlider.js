...
// Import your images
const manhattancool = `${process.env.PUBLIC_URL}/Images/mystyle4.jpg`;
const image2 = `${process.env.PUBLIC_URL}/Images/mystyle5.jpg`;
const image3 = `${process.env.PUBLIC_URL}/Images/mystyle6.jpg`;
