...
<div> 
    ...
    <img src= {Pat1} alt = 'b1' style={{width:'100%'}}></img></div>
    <iframe width="100%" height="415" title='pat' src="https://www.youtube.com/embed/EfpQgD_0PaI" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

<div>

<p style={{ fontSize:'1.5rem', fontFamily: 'GFS Didot, serif', margin: '1rem', maxWidth:'100%' , marginLeft: '1em'}}>
Welcome back, beauties! Let's break down the incredible (and uber-viral) Porcelain Doll makeup looks by Pat McGrath & team, created for the Maison Margiela Spring/Summer '24 runway extravaganza. In a display of sheer genius, Pat McGrath and her team devised a groundbreaking technique, meticulously layering and airbrushing several peel-off masks over the makeup for a truly haute-couture spectacle, creating live porcelain dolls to grace the runway.        </p>
<p style={{ fontSize:'1.5rem', fontFamily: 'GFS Didot, serif', margin: '1rem', maxWidth:'100%' , marginLeft: '1em'}}>
...
<div> <img src= {Pat2} alt = 'b1' style={{width:'100%'}}></img></div>

            <p style={{ fontSize:'2.4rem', fontFamily: 'GFS Didot, serif', margin: '1rem', maxWidth:'100%' , marginLeft: '20%'}}>
...
<div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', marginLeft: '5em', gap: '1em' }}>
        <a href='https://go.shopmy.us/p-3531288'>
        <img src={Pat4} alt="PAT MCGRATH LABS Divine Skin Rose 001 Essence" style={{ maxWidth: '100%', height: 'auto' }} />
    </a>
    <a href='https://go.shopmy.us/p-3891896'>
        <img src={Pat5} alt="Pat McGrath Skin Fetish: Sublime Perfection Primer" style={{ maxWidth: '100%', height: 'auto' }} />
    </a>
    <a href='https://go.shopmy.us/p-3891896'>
        <img src={Pat6} alt="PAT MCGRATH LABS Skin Fetish: Sublime Perfection Foundation" style={{ maxWidth: '100%', height: 'auto' }} />
    </a>
</div>
...
<div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', marginLeft: '5em', gap: '1em' }}>
        <a href='https://go.shopmy.us/p-3532830'>
        <img src={Pat7} alt="PAT MCGRATH LABS Skin Fetish: Sublime Perfection Concealer" style={{ maxWidth: '100%', height: 'auto' }} />
    </a>
    <a href='https://go.shopmy.us/p-3533096'>
        <img src={Pat8} alt="Kryolan Supracolor Palette FP" style={{ maxWidth: '100%', height: 'auto' }} />
    </a>
    <a href='https://go.shopmy.us/p-3532822'>
        <img src={Pat9} alt="PAT MCGRATH LABS Sublime Perfection Blurring Under-Eye powder" style={{ maxWidth: '100%', height: 'auto' }} />
    </a>
</div>
...
<div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', marginLeft: '5em', gap: '1em' }}>
        <a href='https://go.shopmy.us/p-3531292'>
        <img src={Pat10} alt="PAT McGRATH LABS Divine Blush: Legendary Glow Colour Balm" style={{ maxWidth: '100%', height: 'auto' }} />
    </a>
    <a href='https://go.shopmy.us/p-3532832'>
        <img src={Pat11} alt="FRWD Pat McGrath Skin Fetish" style={{ maxWidth: '100%', height: 'auto' }} />
    </a>
    <a href='https://go.shopmy.us/p-3532833'>
        <img src={Pat12} alt="FRWD Pat McGrath Skin Fetish" style={{ maxWidth: '100%', height: 'auto' }} />
    </a>
</div>
...
<div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', marginLeft: '5em', gap: '1em' }}>
        <a href='https://go.shopmy.us/p-3891920'>
        <img src={Pat13} alt="Permagel glide" style={{ maxWidth: '100%', height: 'auto' }} />
    </a>
    <a href='https://go.shopmy.us/p-3532961'>
        <img src={Pat14} alt="Pat McGrath Labs Mothership VI: Midnight Sun" style={{ maxWidth: '100%', height: 'auto' }} />
    </a>
    <a href='https://go.shopmy.us/p-3532925'>
        <img src={Pat15} alt="PAT MCGRATH LABS FetishEyes Mascara 8g" style={{ maxWidth: '100%', height: 'auto' }} />
    </a>
</div>
...
<div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', marginLeft: '5em', gap: '1em' }}>
        <a href='https://go.shopmy.us/p-3532954'>
        <img src={Pat16} alt="Sephora" style={{ maxWidth: '100%', height: 'auto' }} />
    </a>
    <a href='https://go.shopmy.us/p-3532876'>
        <img src={Pat17} alt="PAT McGRATH LABS MatteTrance™ Lipstick" style={{ maxWidth: '100%', height: 'auto' }} />
    </a>
    <a href='https://go.shopmy.us/p-3532902'>
        <img src={Pat18} alt="PAT McGRATH LABS LUST: Lip Gloss" style={{ maxWidth: '100%', height: 'auto' }} />
    </a>
</div>
...
In the livestream, a scientist-like mix was created using QUE BELLA Hydrating Pineapple Peel Off Mask, Daggett & Ramsdell Tea Tree Peel Off Mask, and Freeman Feeling Beautiful Cucumber Facial Peel-Off Mask in Refreshing Cucumber, combined with distilled water. This mix was then poured into an airbrush and applied onto the skin with layers, using a spoon to protect the eye makeup.
            ...
            <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', marginLeft: '5em', gap: '1em' }}>
                    <a href='https://go.shopmy.us/p-3533005'>
        <img src={Pat19} alt="Que Bella Hydrating Pineapple Peel Off Mask" style={{ maxWidth: '100%', height: 'auto' }} />
    </a>
    <a href='https://go.shopmy.us/p-3533079'>
        <img src={Pat20} alt="Daggett & Ramsdell Tea Tree Peel Off Mask" style={{ maxWidth: '100%', height: 'auto' }} />
    </a>
    <a href='https://go.shopmy.us/p-3533084'>
        <img src={Pat21} alt="Freeman Feeling Beautiful Cucumber Facial Peel-Off Mask, Refreshing Cucumber " style={{ maxWidth: '100%', height: 'auto' }} />
    </a>
</div>
...
<div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', marginLeft: '5em', gap: '1em' }}>
        <a href='https://go.shopmy.us/p-3532943'>
        <img src={Pat22} alt="Beautyblender Original Beauty Blender, an edgeless sponge that uses less product to apply makeup" style={{ maxWidth: '100%', height: 'auto' }} />
    </a>
    <a href='https://go.shopmy.us/p-3533111'>
        <img src={Pat23} alt="TEMPTU SP35 GRAVITY FED AIRBRUSH" style={{ maxWidth: '100%', height: 'auto' }} />
    </a>
    <a href='https://go.shopmy.us/p-3533103'>
        <img src={Pat24} alt="PPI SKIN ILLUSTRATOR INK - CLEAR GLOSS" style={{ maxWidth: '100%', height: 'auto' }} />
    </a>
</div>
...
<p style={{ fontSize:'1.5rem', fontFamily: 'GFS Didot, serif', margin: '1rem', maxWidth:'100%' , marginLeft: '1em'}}>
I hope you enjoyed this 1930s-meets-porcelain-doll otherworldly look. Comment your thoughts below, and if you want to be featured on my site, submit your recreations of this look here! I’d love to see how you switch up your style and practice your artistry.  </p>



<div> <img src= {Pat25} alt = 'Jackie Wyers Signature' style={{width:'100%'}}></img></div>
    ...
    return (
        ...
        <HyvorTalkComments
        websiteId={websiteId}
        pageId={"Pat-McGrath"} // Unique identifier for this blog post
    /></div>
    );
